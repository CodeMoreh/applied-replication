...
- **Explore**: the companion curriculum (intro to R · the statistics behind today · the multiverse debate · simulation · repositories & preregistration · git & GitHub) · the Multi100 data · `fixest` & `dagitty` docs
