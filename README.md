...
- **Route 2 – Browser lab (zero-install).** Participants open the [browser lab](exercise/browser-lab.qmd), which runs Tasks 1–5 in-browser via webR and quarto-live. Nothing is installed, the data is pre-loaded, and work persists in the tab until refresh.
