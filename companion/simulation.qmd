...
# The specification that the twin reproduces at cell level: the day's anchor
...
#| fig-width: 8
#| fig-height: 3.6
#| fig-cap: "Independent draws from the same recipe, each refitted with the anchor specification. Red marks show the planted coefficient. The unemployment slopes sit consistently outside their marks, which is the bias that the text discusses."
