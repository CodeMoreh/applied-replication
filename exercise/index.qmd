...
This page sets out the whole exercise. Your work happens either in the [Browser lab](browser-lab.qmd) (Route 2) or in the Positron workspace you downloaded (Route 1). The two routes are identical in what they let you do. Come back here whenever you want the overview again.
...
The justification is what the whole exercise turns on. Auspurg & Brüderl (2021) argue that a multiverse of unjustified specifications shows dispersion and nothing more; the stated reasons are what let it count as evidence.
...
Two of the eight [companion modules](../companion/index.qmd) take the skills the day sets aside further, at your own pace:
