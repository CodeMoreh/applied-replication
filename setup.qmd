...
**Step 1 – Install R.** R is the language that the analysis is written in. Download it from [cran.r-project.org](https://cran.r-project.org/) and run the installer for your system (Windows `.exe`, macOS `.pkg`, or your Linux package manager). Accept the defaults.
...
| [Reading a specification curve](exercise/reading-inference.qmd) | The workshop's own reading for the final part of the day: what a large set of results together can and cannot establish, and why thousands of estimates are not thousands of tests. |
